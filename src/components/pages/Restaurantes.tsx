      ...
      <div className="min-h-[80vh]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
          {restaurantes.map((restaurante) => (
            <div className="container flex flex-col rounded-2xl overflow-hidden shadow-lg bg-white ">
              <header className="py-2 px-6 bg-sky-400 text-white font-bold text-2xl w-full text-center">
                {restaurante.nome}
              </header>
              <p className="p-2 text-2xl bg-gray-300 h-full ">
                {restaurante.endereco}
              </p>
              <div className="p-1 bg-fuchsia-500 flex flex-col gap-2 w-full text-end">
