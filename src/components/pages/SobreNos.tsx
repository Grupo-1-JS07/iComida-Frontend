...
import Samara from '../../assets/Samara.jpeg';
...
function SobreNos() {
  const teamMembers = [
    ...
    { name: 'Sâmara', photo: Samara, bio: 'Arquiteto dos algoritmos de IA que gerenciam nossa frota de drones.' },
  ...
  return (
    ...
    >
      <div className="bg-black/50 rounded-xl p-10 text-center w-full max-w-4xl mb-12 backdrop-blur-sm">
      ...
      <section className="w-full max-w-6xl bg-gray-900/70 rounded-xl p-8 backdrop-blur-md">
        <h2 className="text-3xl font-semibold text-cyan-400 mb-6 text-center drop-shadow-md">
          Nosso Time
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-gray-800/70 rounded-lg p-4 text-center hover:scale-105 transition-transform duration-300 backdrop-blur-md">
